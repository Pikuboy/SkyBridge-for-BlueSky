...
MastodonInstance _$MastodonInstanceFromJson(Map<String, dynamic> json) =>
    MastodonInstance(
      ...
      thumbnail: InstanceThumbnail.fromJson(
...
InstanceThumbnail _$InstanceThumbnailFromJson(Map<String, dynamic> json) =>
    InstanceThumbnail(
      ...
      versions: ThumbnailVersions.fromJson(
...
Map<String, dynamic> _$ThumbnailVersionsToJson(ThumbnailVersions instance) =>
    <String, dynamic>{'@1x': instance.oneTimes, '@2x': instance.twoTimes};
...
PollConfiguration _$PollConfigurationFromJson(Map<String, dynamic> json) =>
    PollConfiguration(
      ...
      maxCharactersPerOption: (json['max_characters_per_option'] as num)
          .toInt(),
...
TranslationConfiguration _$TranslationConfigurationFromJson(
  Map<String, dynamic> json,
) => TranslationConfiguration(enabled: json['enabled'] as bool);
...
Rule _$RuleFromJson(Map<String, dynamic> json) =>
    Rule(id: json['id'] as String, text: json['text'] as String);
...
UsersUsageInfo _$UsersUsageInfoFromJson(Map<String, dynamic> json) =>
    UsersUsageInfo(activeMonth: (json['active_month'] as num).toInt());
